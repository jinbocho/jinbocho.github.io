...
graph LR
    ...
    OB2["📗 Copia di un altro familiare<br/>Scaffale 1 · Pos. 5<br/>Da leggere"]
    BR --> OB1
    BR --> OB2
...
!!! info "Perché sono due cose separate?"
    Più familiari possono avere la stessa copia di un libro. Ognuno ha il proprio record
...
!!! tip "Utile per le biblioteche condivise"
    In una biblioteca di famiglia, lo storico ti dice chi ha spostato un libro e quando —
